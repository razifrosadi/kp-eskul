                ...
                <div class="col-lg">
                    <div class="p-5">
                        ...
                        <form class="user" method="post" action="<?= base_url('index.php/Auth/registration'); ?>">
                            ...
                            <div class="form-group">
                                <textarea class="form-control form-control-user" rows="3" type="text" class="form-control form-control-user" id="alamat" name="alamat" placeholder="Isi Alamat Lengkap" value="<?= set_value('alamat'); ?>">></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="ekskul" name="ekskul" placeholder="Ekskul" value="<?= set_value('ekskul'); ?>">
